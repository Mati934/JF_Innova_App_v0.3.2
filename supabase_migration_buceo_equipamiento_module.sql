...
SELECT
  'BUCEO_SAM_36M' AS lista_codigo,
  'Checklist base SAM' AS categoria,
  'Completar checklist específico SAM 36 m según procedimiento vigente.' AS pregunta,
  false AS aplica_por_buzo,
  'Intolerable' AS criticidad,
  1 AS peso,
  10 AS orden,
  true AS activo
ON CONFLICT (lista_codigo, pregunta)
...
WHERE i.lista_codigo = 'BUCEO_SAL_20M';
